...
--
-- Table structure for table `my_innodb_buffer_page`
--

DROP TABLE IF EXISTS `my_innodb_buffer_page`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `my_innodb_buffer_page` (
...
--
-- Dumping data for table `my_innodb_buffer_page`
--

LOCK TABLES `my_innodb_buffer_page` WRITE;
/*!40000 ALTER TABLE `my_innodb_buffer_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `my_innodb_buffer_page` ENABLE KEYS */;
UNLOCK TABLES;
